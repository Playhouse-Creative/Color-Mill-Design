...
const IndexPage = (props) => {
  ...
  return(
    ...
    <Layout>
        ...
        <Grid container spacing={2} name='gallery' style={{ padding: '4rem 0 8rem 0'}} >
          <BourbonCard/>
          <NoyoCard/>
          <UMSPCard/>
          <LogosCard/>
      ...
      <Grid container style={{padding:'8% 10%', backgroundColor: '#49BEAA'}}>
        ...
        <Grid item xs={12} sm={5} style={{ color:'#E9F1F7', paddingRight:'1rem'}}>
        <h3>
        Brand Identity
        </h3>
        <h3>
      ...
      <Grid container style={{height:500, backgroundColor: '#E9F1F7'}}>
      </Grid>
    </Layout>
